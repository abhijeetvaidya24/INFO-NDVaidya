...
final class InAppPurchaseController$1$$Lambda$1
implements Runnable {
    private final InAppPurchaseController.1 arg$1;

    private InAppPurchaseController$1$$Lambda$1(InAppPurchaseController.1 var1_1) {
        this.arg$1 = var1_1;
    }

    public static Runnable lambdaFactory$(InAppPurchaseController.1 var0) {
        return new InAppPurchaseController$1$$Lambda$1(var0);
    }

    public void run() {
        InAppPurchaseController.1.lambda$onBillingSetupFinished$0((InAppPurchaseController.1)this.arg$1);
    }
}
