 ...
 *  com.startapp.android.publish.ads.nativead.b
...
implements NativeAdDetails.a {
    ...
    public ArrayList<NativeAdDetails> getNativeAds(String string) {
        ArrayList arrayList = new ArrayList();
        f f2 = com.startapp.android.publish.adsCommon.a.g.a().b().a(AdPreferences.Placement.INAPP_NATIVE, string);
        if (f2.a()) {
            List<NativeAdDetails> list = this.listNativeAds;
            if (list != null) {
            ...
            c.a(this.context, c.a(this.getAdDetailsList()), string, f2.c());
            if (Constants.a().booleanValue()) {
                i.a().a(this.context, f2.b());
            }
        }
        return arrayList;
    }
    ...
    void initNativeAdList() {
        ...
        com.startapp.android.publish.ads.nativead.b b2 = this.nativeAd;
        if (b2 != null) {
            List list = b2.d();
            if (list != null) {
    ...
    public boolean loadAd(NativeAdPreferences nativeAdPreferences, AdEventListener adEventListener) {
        ...
        this.isLoading = true;
        this.nativeAd = new com.startapp.android.publish.ads.nativead.b(this.context, this.getPreferences());
        return this.nativeAd.load((AdPreferences)nativeAdPreferences, (AdEventListener)this.adEventDelegate);
    }
