...
public class a {
    ...
    public Bitmap a(int n2, String string, String string2) {
        ...
        if (!this.c.contains((Object)string)) {
            ...
            int n3 = this.e;
            if (n3 >= 15) {
                this.f.add((Object)new b(n2, string, string2));
            } else {
                this.e = n3 + 1;
                new a(n2, string, string2).execute((Object[])new Void[0]);
            }
        }
        return null;
    }
    ...
    public void a(String string) {
        HashMap<String, i> hashMap = this.a;
        if (hashMap != null && hashMap.containsKey((Object)string) && this.a.get((Object)string) != null) {
