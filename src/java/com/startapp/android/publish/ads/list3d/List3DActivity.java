...
implements g {
    ...
    private boolean d() {
        ...
        if (l2 != null) {
            ...
            long l3 = System.currentTimeMillis() - this.i LCMP this.j;
            bl = false;
            if (l3 > 0) {
                bl = true;
            }
    ...
    protected com.startapp.android.publish.adsCommon.d.b a() {
        ...
        return new com.startapp.android.publish.adsCommon.d.a(String.valueOf((double)(d2 / 1000.0)), this.b);
    }
    ...
    protected String b() {
        ...
        String string = "";
        if (list != null && !list.isEmpty() && ((ListItem)this.c.get(0)).d() != null) {
            string = ((ListItem)this.c.get(0)).d();
        }
        return string;
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        try {
            ...
            b2 = new b((Context)this, this.c, string, this.b, this.a);
            e2 = f.a().a(this.a);
            bl = !bl2;
        }
        catch (Throwable throwable) {
            com.startapp.common.a.g.a("List3DActivity", 6, "List3DActivity.onCreate", throwable);
            com.startapp.android.publish.adsCommon.f.f.a((Context)this, com.startapp.android.publish.adsCommon.f.d.b, "List3DActivity.onCreate", throwable.getMessage(), "");
            this.finish();
            return;
        }
        e2.a(this, bl);
        ...
        this.d.setOnItemClickListener(new AdapterView.OnItemClickListener(this){
            ...
            private void a(String string, String string2, String string3, String string4) {
                ...
                com.startapp.android.publish.adsCommon.c.a(string, string2, string3, (Context)list3DActivity, new com.startapp.android.publish.adsCommon.d.b(list3DActivity.b));
                this.a.finish();
            }
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int n2, long l2) {
                ...
                boolean bl = ((ListItem)this.a.c.get(n2)).l();
                boolean bl2 = ((ListItem)this.a.c.get(n2)).m();
                String string4 = ((ListItem)this.a.c.get(n2)).p();
                String string5 = ((ListItem)this.a.c.get(n2)).o();
                Boolean bl3 = ((ListItem)this.a.c.get(n2)).s();
                f.a().a(this.a.a).a(((ListItem)this.a.c.get(n2)).c());
                if (string4 != null && !TextUtils.isEmpty((CharSequence)string4)) {
                    this.a(string4, string5, string, string2);
                    return;
                }
                if (!TextUtils.isEmpty((CharSequence)string)) {
                    boolean bl4 = com.startapp.android.publish.adsCommon.c.a(this.a.getApplicationContext(), AdPreferences.Placement.INAPP_OFFER_WALL);
                    if (bl && !bl4) {
                        List3DActivity list3DActivity = this.a;
                        com.startapp.android.publish.adsCommon.c.a((Context)list3DActivity, string, string2, string3, list3DActivity.a(), com.startapp.android.publish.adsCommon.b.a().A(), com.startapp.android.publish.adsCommon.b.a().B(), bl2, bl3, false, new Runnable(this){
                            final /* synthetic */ 2 a;
                            {
                                this.a = var1_1;
                            }
                    ...
                    List3DActivity list3DActivity = this.a;
                    com.startapp.android.publish.adsCommon.d.b b2 = list3DActivity.a();
                    boolean bl5 = bl2 && !bl4;
                    com.startapp.android.publish.adsCommon.c.a((Context)list3DActivity, string, string2, b2, bl5, false);
                    this.a.finish();
                }
            }
        });
        ...
        Bitmap bitmap = a.a((Context)this, "close_button.png");
        if (bitmap != null) {
        ...
        textView.setOnClickListener(new View.OnClickListener(this){
            ...
            public void onClick(View view) {
                List3DActivity list3DActivity = this.a;
                com.startapp.android.publish.adsCommon.c.b((Context)list3DActivity, list3DActivity.b(), this.a.a());
                this.a.finish();
            }
        });
        ...
        textView3.setPadding(0, h.a((Context)this, 2), 0, h.a((Context)this, 3));
        textView3.setText((CharSequence)"Powered By ");
        textView3.setTextSize(16.0f);
        linearLayout2.addView((View)textView3);
        ImageView imageView = new ImageView((Context)this);
        imageView.setImageBitmap(Bitmap.createScaledBitmap((Bitmap)a.a((Context)this, "logo.png"), (int)h.a((Context)this, 56), (int)h.a((Context)this, 12), (boolean)true));
    ...
    protected void onPause() {
        super.onPause();
        f.a().a(this.a).b();
        com.startapp.android.publish.adsCommon.adinformation.b b2 = this.h;
        if (b2 != null && b2.b()) {
            this.h.d();
        }
        this.overridePendingTransition(0, 0);
        String string = this.k;
        if (string != null && string.equals((Object)"back")) {
            this.finish();
        }
    }
    ...
    protected void onSaveInstanceState(Bundle bundle) {
        ...
        Long l3 = this.i;
        if (l3 != null) {
            bundle.putSerializable("lastLoadTime", (Serializable)l3);
        }
        if ((l2 = this.j) != null) {
            bundle.putSerializable("adCacheTtl", (Serializable)l2);
        }
    }
}
