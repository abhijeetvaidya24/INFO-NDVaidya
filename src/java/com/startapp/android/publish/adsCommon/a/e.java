...
implements Serializable {
    ...
    @com.startapp.common.c.f(b="Ljava/util/HashMap;", c="Ljava/util/ArrayList;", d="Lcom/startapp/android/publish/common/model/AdPreferences$Placement;", e="Lcom/startapp/android/publish/adsCommon/a/c;")
    private Map<AdPreferences.Placement, List<c>> placements = new HashMap();
    @com.startapp.common.c.f(b="Ljava/util/ArrayList;", c="Lcom/startapp/android/publish/adsCommon/a/c;")
    private List<c> session = new ArrayList();
    @com.startapp.common.c.f(b="Ljava/util/HashMap;", c="Ljava/util/ArrayList;", e="Lcom/startapp/android/publish/adsCommon/a/c;")
    ...
    public f a(AdPreferences.Placement placement, String string) {
        ...
        synchronized (e2) {
            String string2;
            this.a.clear();
            f f2 = this.a((List<c>)((List)this.tags.get((Object)string)), b.a().a(string), d.a, string);
            if (f2.a() && (f2 = this.a((List<c>)((List)this.placements.get((Object)placement)), b.a().a(placement), d.b, placement.toString())).a()) {
                f2 = this.a(this.session, b.a().c(), d.c, "session");
            }
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("shouldDisplayAd result: ");
            stringBuilder.append(f2.a());
            if (f2.a()) {
                string2 = "";
            } else {
                StringBuilder stringBuilder2 = new StringBuilder();
                stringBuilder2.append(" because of rule ");
                stringBuilder2.append(f2.b());
                string2 = stringBuilder2.toString();
            }
            stringBuilder.append(string2);
            g.a("AdRules", 3, stringBuilder.toString());
            return f2;
        }
    }
