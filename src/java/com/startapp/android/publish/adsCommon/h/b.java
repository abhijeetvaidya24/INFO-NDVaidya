...
public class b
extends a {
    public b(Context context, Runnable runnable, com.startapp.android.publish.adsCommon.f.b b2) {
    ...
    private boolean c() {
        ...
        boolean bl = l4 - (l2 = k.a(this.a, "lastBtDiscoveringTime", 0L).longValue()) >= (l3 = 60000L * (long)MetaData.getInstance().getBluetoothConfig().c());
        if (bl) {
