...
public class f {
    protected StartAppAd a = null;
    private boolean b = false;
    private AutoInterstitialPreferences c = null;
    private long d = -1L;
    private int e = -1;
    ...
    private boolean f() {
        ...
        int n2 = this.e;
        boolean bl2 = n2 <= 0 || n2 >= this.c.getActivitiesBetweenAds();
        boolean bl3 = false;
        if (bl) {
            bl3 = false;
            if (bl2) {
    ...
    public void a(Activity activity, Bundle bundle) {
        if (bundle == null && !this.a(activity) && !this.b(activity)) {
            this.e = 1 + this.e;
    ...
    public void a(Context context) {
        if (this.e() && this.f()) {
            ...
            this.a.loadAd(StartAppAd.AdMode.AUTOMATIC, new AdPreferences().setAi(true), (AdEventListener)new 1(this));
        }
    }
