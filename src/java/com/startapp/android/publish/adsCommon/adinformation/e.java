 ...
 *  com.startapp.android.publish.adsCommon.adinformation.e$1
...
implements Serializable {
    ...
    public String d() {
        String string = this.imageUrlSecured;
        if (string != null) {
            return string;
        }
        return "";
    ...
    protected void e() {
        this.a((Bitmap)null);
        new com.startapp.common.a(this.d(), (a.a)new 1(this), 0).a();
    }
