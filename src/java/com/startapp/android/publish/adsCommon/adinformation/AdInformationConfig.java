...
implements Serializable {
    ...
    public boolean a(Context context) {
        boolean bl = k.a(context, "userDisabledAdInformation", false);
        boolean bl2 = false;
        if (!bl) {
            boolean bl3 = this.d();
            bl2 = false;
    ...
    public String f() {
        String string = this.dialogUrlSecured;
        if (string != null) {
            return string;
        }
    ...
    protected void h() {
        for (ImageResourceType imageResourceType : ImageResourceType.values()) {
            ...
            stringBuilder.append("AdInformation error in ImageResource [");
    ...
    extends Enum<ImageResourceType> {
        ...
        public static ImageResourceType getByName(String string) {
            ...
            for (int j = 0; j < arrimageResourceType.length; ++j) {
                if (arrimageResourceType[j].name().toLowerCase().compareTo(string.toLowerCase()) != 0) continue;
                imageResourceType = arrimageResourceType[j];
            }
