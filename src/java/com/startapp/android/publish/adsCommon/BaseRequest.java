...
implements NameValueSerializer {
    ...
    private void addParams(e e2) {
        ...
        if (map != null && !map.isEmpty()) {
            Iterator iterator = this.frameworksMap.keySet().iterator();
            String string2 = "";
        ...
        b.c c2 = this.userAdvertisingId;
        if (c2 != null) {
            e2.a("userAdvertisingId", c2.a(), false);
            ...
            String string4 = this.androidId;
            if (string4 != null) {
                e2.a("userId", string4, false);
            }
        }
        ...
        if (this.getCellTimingAdv() != null) {
            e2.a("cellTimingAdv", this.getCellTimingAdv(), false);
        }
        ...
        if (this.getLocations() != null && this.getLocations().size() > 0 && (string = f.a(this.getLocations())) != null && !string.equals((Object)"")) {
            e2.a("locations", com.startapp.common.a.a.c(string), false);
        }
        e2.a("udbg", this.usbDebug, false);
        e2.a("root", this.root, false);
        e2.a("smltr", this.simulator, false);
        e2.a("pas", this.personalizedAdsServing, false);
    }
     ...
     */
    private void fillWifiDetails(Context var1, boolean var2) {
    ...
    private void setNetworkLevels(Context context) {
        try {
            ...
            boolean bl = MetaData.getInstance().isWfScanEnabled();
            h.b b2 = null;
            if (bl) {
                b2 = h.a(context, this.networkType);
            }
            if (b2 == null) {
            ...
            if (b2.a() == null) {
                this.signalLevel = b2.c();
                this.wifiRSSILevel = b2.b();
                this.wifiSignalLevel = b2.c();
                return;
            }
            this.signalLevel = b2.a();
            this.wifiRSSILevel = b2.a();
            this.wifiSignalLevel = b2.a();
            return;
        }
    ...
    public static void setUsingLocation(Context context, boolean bl) {
        k.b(context, "shared_prefs_using_location", bl);
    }
    ...
    public void fillLocationDetails(AdPreferences adPreferences, Context context) {
        ...
        m.a().h(context);
        List<Location> list = f.a(context, MetaData.getInstance().getLocationConfig().isFiEnabled(), MetaData.getInstance().getLocationConfig().isCoEnabled());
        if (list != null && list.size() > 0) {
            this.locations.addAll(list);
            bl = true;
        }
        BaseRequest.setUsingLocation(context, bl);
    }
    ...
    public String getSessionId() {
        String string = this.clientSessionId;
        if (string == null) {
            string = "";
        }
        return string;
    ...
    public String toString() {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("BaseRequest [parameters=");
