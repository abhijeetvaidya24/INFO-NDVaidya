...
extends b {
        ...
        if (n3 < 0) {
            ...
            if (n5 != 0) {
                if (n5 != 1) {
                    ...
                    int n6 = a2.d;
                    a2.d = n6 + 1;
                    arrby2[n6] = this.g[63 & a2.a >> 10];
                    int n7 = a2.d;
                    a2.d = n7 + 1;
                    arrby2[n7] = this.g[63 & a2.a >> 4];
                    int n8 = a2.d;
                    a2.d = n8 + 1;
                    arrby2[n8] = this.g[63 & a2.a << 2];
                    if (this.g == d) {
                        int n9 = a2.d;
                        a2.d = n9 + 1;
                        arrby2[n9] = 61;
                    ...
                    int n10 = a2.d;
                    a2.d = n10 + 1;
                    arrby2[n10] = this.g[63 & a2.a >> 2];
                    int n11 = a2.d;
                    a2.d = n11 + 1;
                    arrby2[n11] = this.g[63 & a2.a << 4];
                    if (this.g == d) {
                        int n12 = a2.d;
                        a2.d = n12 + 1;
                        arrby2[n12] = 61;
    ...
    protected boolean a(byte by) {
        byte[] arrby;
        return by >= 0 && by < (arrby = this.h).length && arrby[by] != -1;
    }
}
