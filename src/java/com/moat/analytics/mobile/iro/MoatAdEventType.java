...
extends Enum<MoatAdEventType> {
    ...
    private static final /* synthetic */ MoatAdEventType[] \u0971;
    ...
    static {
        ...
        \u0971 = arrmoatAdEventType;
    }

    private MoatAdEventType(String string2) {
        this.\u02cb = string2;
    }

    public static MoatAdEventType fromString(String string) {
        if (string != null) {
            for (MoatAdEventType moatAdEventType : MoatAdEventType.values()) {
                if (!string.equalsIgnoreCase(moatAdEventType.toString())) continue;
    ...
    public static MoatAdEventType valueOf(String string) {
        return (MoatAdEventType)Enum.valueOf(MoatAdEventType.class, (String)string);
    }

    public static MoatAdEventType[] values() {
        return (MoatAdEventType[])\u0971.clone();
    }
