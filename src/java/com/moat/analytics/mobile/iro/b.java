...
final class b {
    ...
    b(Application application, int n2) {
        this.\u02ce = n2;
        this.\u0971 = false;
        ...
        WebSettings webSettings = this.\u02cf.getSettings();
        ...
        try {
            this.\u02cb = new f(this.\u02cf, n3);
            return;
        }
        catch (o o2) {
            o.\u0971((Exception)((Object)o2));
            return;
        }
    }

    static void \u02ca(String string, Object object, String string2, Exception exception) {
        if (t.\u02cb().\u02ce) {
    ...
    static void \u02ce(String string, String string2) {
    ...
    final void \u02cb(String string) {
        if (this.\u02ce == a.\u02cf) {
            this.\u02cf.setWebViewClient(new WebViewClient(this){
                private /* synthetic */ b \u02cf;
                {
                    this.\u02cf = b2;
                }
    ...
    final void \u02ce(String string, Map<String, String> map, Integer n2, Integer n3, Integer n4) {
        if (this.\u02ce == a.\u02ce) {
            this.\u02cf.setWebViewClient(new WebViewClient(this){
                private /* synthetic */ b \u0971;
                {
                    this.\u0971 = b2;
                }
