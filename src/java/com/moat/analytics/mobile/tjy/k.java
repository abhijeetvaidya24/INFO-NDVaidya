...
extends Enum {
    public static final /* enum */ k a = new k("UNINITIALIZED", 0);
    public static final /* enum */ k b = new k("PAUSED", 1);
    public static final /* enum */ k c = new k("PLAYING", 2);
    public static final /* enum */ k d = new k("STOPPED", 3);
    public static final /* enum */ k e = new k("COMPLETED", 4);
