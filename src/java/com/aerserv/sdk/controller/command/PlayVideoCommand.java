...
implements Command {
    ...
    public void execute() {
        try {
            AerServLog.d(this.getClass().getName(), "Playing video");
            new ASAerServInterstitialProvider(this.properties).requestAd();
            return;
        }
        catch (JSONException jSONException) {
            AerServLog.e(this.getClass().getName(), "Exception caught while trying to play video", (Exception)((Object)jSONException));
