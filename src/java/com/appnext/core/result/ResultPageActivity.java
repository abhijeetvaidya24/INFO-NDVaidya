 ...
 *  com.appnext.core.result.ResultPageActivity$1
 *  com.appnext.core.result.ResultPageActivity$3
 *  com.appnext.core.result.ResultPageActivity$CustomAd
 *  com.appnext.core.result.ResultPageActivity$b$1
 *  com.appnext.core.result.b
 *  java.lang.Object
 *  java.lang.Runnable
 *  java.lang.String
 ...
 */
public class ResultPageActivity
extends Activity {
    private AppnextAd aE;
    private String ca;
    private boolean cd;
    private String fM;
    private AppnextAd ie;
    private String if;
    private com.appnext.core.result.a ig;
    private c ih;
    ...
    static /* synthetic */ c a(ResultPageActivity resultPageActivity) {
        return resultPageActivity.ih;
    }
    ...
    static /* synthetic */ boolean f(ResultPageActivity resultPageActivity) {
        return resultPageActivity.cd;
    }
    ...
    private String getJSurl() {
        com.appnext.core.result.a a2 = this.ig;
        if (a2 != null) {
            a2.getJSurl();
            return this.ig.getJSurl();
        }
    ...
    private CustomAd h(AppnextAd appnextAd) {
        return new /* Unavailable Anonymous Inner Class!! */;
    }

    protected final void loadJS(String string2) {
        new StringBuilder("loading js ").append(string2);
    ...
    protected final void loadWebview(String string2, String string3) {
        try {
            ...
            StringBuilder stringBuilder2 = new StringBuilder("<html><body><script>");
            stringBuilder2.append(string3);
            stringBuilder2.append("</script></body></html>");
            String string5 = stringBuilder2.toString();
            this.webView.loadDataWithBaseURL(string4, string5, null, "UTF-8", null);
        }
    ...
    protected void onCreate(Bundle bundle) {
        ...
        try {
            this.ih = d.bp().bq();
            this.placementID = this.ih.getPlacementId();
            this.if = this.ih.z();
            this.cd = this.getIntent().getExtras().getBoolean("shouldClose");
            this.ie = this.ih.getSelectedAd();
            this.fM = this.ih.A();
            this.ca = this.ih.B();
        ...
        this.webView.setWebChromeClient(new WebChromeClient(){
            ...
            public final boolean onConsoleMessage(ConsoleMessage consoleMessage) {
                StringBuilder stringBuilder = new StringBuilder("[");
                stringBuilder.append(consoleMessage.messageLevel().name());
        ...
        this.webView.setWebViewClient((WebViewClient)new a());
        com.appnext.core.result.a a2 = this.ig;
        if (a2 != null) {
            a2.getJSurl();
            string2 = this.ig.getJSurl();
        } else {
            string2 = "https://cdn.appnext.com/tools/sdk/banner/2.4.3/result.min.js";
        }
        AppnextWebView.u((Context)this).a(string2, (AppnextWebView.c)new 3(this, string2));
        this.webView.addJavascriptInterface((Object)new b(), "Appnext");
    }
    ...
    public g parseAd(String string2) {
        AppnextAd appnextAd;
        block3 : {
            ...
            try {
                ...
                if (appnextAd == null) break block3;
            }
            catch (Throwable throwable) {
                return null;
            }
            this.h(appnextAd).setAdJSON(jSONObject.toString());
            if (!appnextAd.getStoreRating().equals((Object)"")) break block3;
            this.h(appnextAd).setStoreRating("0");
        }
        return appnextAd;
    }
        ...
        public final void onPageFinished(WebView webView, String string2) {
            ...
            new Thread(new Runnable(){
                ...
                public final void run() {
                    final String string2 = f.b((Context)ResultPageActivity.this, false);
                    new Handler(Looper.getMainLooper()).post(new Runnable(){

                        public final void run() {
                            try {
                                ResultPageActivity resultPageActivity = ResultPageActivity.this;
                                StringBuilder stringBuilder = new StringBuilder("Appnext.setParams(");
                                stringBuilder.append(d.bp().bq().getConfigParams().put("did", (Object)string2).toString());
                                stringBuilder.append(");");
                                resultPageActivity.loadJS(stringBuilder.toString());
                            }
                            catch (Throwable throwable) {}
                            ResultPageActivity resultPageActivity = ResultPageActivity.this;
                            StringBuilder stringBuilder = new StringBuilder("Appnext.load(");
                            stringBuilder.append(ResultPageActivity.this.h(ResultPageActivity.this.ie).getAdJSON());
                            stringBuilder.append(",");
                            stringBuilder.append(ResultPageActivity.this.ca);
                            stringBuilder.append(",");
                            stringBuilder.append(ResultPageActivity.this.fM);
                            stringBuilder.append(");");
                            resultPageActivity.loadJS(stringBuilder.toString());
                        }
                    });
    ...
    public final class b {
        @JavascriptInterface
        public final void adClicked(String string2, int n2) {
            ResultPageActivity resultPageActivity = ResultPageActivity.this;
            resultPageActivity.aE = (AppnextAd)resultPageActivity.parseAd(string2);
            q q2 = ResultPageActivity.this.userAction;
            AppnextAd appnextAd = ResultPageActivity.this.aE;
            StringBuilder stringBuilder = new StringBuilder();
            ResultPageActivity resultPageActivity2 = ResultPageActivity.this;
            stringBuilder.append(resultPageActivity2.h(resultPageActivity2.aE).getAppURL());
            stringBuilder.append("&tem_id=");
            stringBuilder.append(ResultPageActivity.this.if);
            stringBuilder.append("1");
            q2.a(appnextAd, stringBuilder.toString(), ResultPageActivity.this.placementID, (e.a)new 1(this));
        }

        @JavascriptInterface
        public final void impression(String string2) {
            AppnextAd appnextAd = (AppnextAd)ResultPageActivity.this.parseAd(string2);
            ResultPageActivity.this.userAction.e(appnextAd);
        }

        @JavascriptInterface
        public final void openLink(String string2) {
        ...
        @JavascriptInterface
        public final void postView(String string2) {
            AppnextAd appnextAd = (AppnextAd)ResultPageActivity.this.parseAd(string2);
            q q2 = ResultPageActivity.this.userAction;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append(ResultPageActivity.this.h(appnextAd).getImpressionURL());
            stringBuilder.append("&tem_id=");
            stringBuilder.append(ResultPageActivity.this.if);
            stringBuilder.append("1");
            q2.a(appnextAd, stringBuilder.toString(), null);
        }
    }
