...
public class TapjoyConstants {
    ...
    public static final String TJC_BRIDGE_VERSION_NUMBER = "1.0.11";
    ...
    public static final int TJC_LIBRARY_VERSION_INT = 11122;
    public static final String TJC_LIBRARY_VERSION_NUMBER = "11.12.2";
    ...
    public static final String[] dependencyPermissions = new String[]{"android.permission.INTERNET", "android.permission.ACCESS_NETWORK_STATE"};
    public static final String[] optionalPermissions = new String[]{"android.permission.ACCESS_WIFI_STATE"};
}
