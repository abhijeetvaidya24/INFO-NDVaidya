...
extends o {
    ...
    public k(SharedPreferences sharedPreferences, String string) {
    ...
    public final double a() {
        ...
        // org.benf.cfr.reader.util.ConfusedCFRException: Invalid stack depths @ lbl15.1 : ALOAD_0 : trying to set 0 previously set to 1
    ...
    public final SharedPreferences.Editor a(SharedPreferences.Editor editor, double d2) {
        return editor.putString(this.b, Double.toString((double)d2));
    }
}
